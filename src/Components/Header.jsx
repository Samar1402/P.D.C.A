    ...
    <div>
      <div className="flex px-12 py-4 bg-blue-950 justify-between">
        ...
        <div className="flex flex-col">
          <div>
            {/* Call onNavigate with "login" to show the Login page */}
            <button
          ...
          <div className="flex justify-center gap-2">
            <FontAwesomeIcon icon={faWhatsapp} className="text-xl text-white mt-3 mr-5" />
            <FontAwesomeIcon icon={faFacebook} className="text-xl text-white mt-3 mr-5" />
            <FontAwesomeIcon icon={faTwitter} className="text-xl text-white mt-3 mr-5" />
          </div>
        </div>
      </div>
    </div>
