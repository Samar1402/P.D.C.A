...
//             className={`${
//               activeForm === "entry" ? "bg-blue-600" : "bg-blue-400 transform hover:scale-105 transition-all duration-300"
...
//             className={`${
//               activeForm === "service" ? "bg-blue-600" : "bg-blue-400 transform hover:scale-105 transition-all duration-300"
...
//         </div>
//       </header>
//       <div className="bg-white shadow-md rounded-md p-6 px-48 w-[70%] mt-8">
//         <div className="mb-6">
//           <h3 className="text-2xl font-bold text-center text-gray-800">
//             {activeForm === "entry" ? "Member Entry Form" : "Member Service Form"}
//           </h3>
//         </div>
//         {activeForm === "entry" ? (
...
//                 Submit
//               </button>
//               <button className="bg-red-500 text-white py-2 px-4 rounded-md hover:bg-gray-600 focus:ring-2 focus:ring-gray-300 transform hover:scale-105 transition-all duration-300">
